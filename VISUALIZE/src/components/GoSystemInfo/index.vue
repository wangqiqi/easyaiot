    ...
    <n-list bordered class="go-system-info">
      ...
      <n-list-item>
        <n-space class="go-my-2" :size="20">
          <n-text class="item-left">产品名称：</n-text>
          <n-text>EasyAIoT</n-text>
        </n-space>
      </n-list-item>

      <n-list-item>
        <n-space class="go-my-2" :size="20">
          <n-text class="item-left">产品简介：</n-text>
          <n-text>高效、高性能的拖拽式低代码数据可视化开发平台</n-text>
        </n-space>
      </n-list-item>
    </n-list>
  </n-modal>
