...
module.exports = {
    ...
    // EasyAIoT SSO：开启后由平台代登录，经 /easyaiot-sso.html 写入 sessionStorage 再跳转
    secureEnabled: true,
    secretCode: 'easyaiot-fuxa-sso-change-me',
    tokenExpiresIn: '8h',  // '1h'=1hour, 60=60seconds, '1d'=1day
    ...
    // 仅编辑器要求登录时设为 true；平台 SSO 已覆盖编辑+预览，保持 false
