...
export const getServiceBasicColumns = (functionType : String): BasicColumn[] => {
...
export function getServiceFormConfig(): Partial<FormProps> {
  return {
    labelWidth: 70,
...
export function getDeviceBasicColumns(): BasicColumn[] {
  return [
    {
      title: '应用场景',
      dataIndex: 'appId',
...
export function getDeviceFormConfig(): Partial<FormProps> {
  return {
    labelWidth: 80,
    baseColProps: { span: 6 },
    schemas: [
